	...
	override public function init()
	{
		...
		addWhenDrawingListener(null, function(g:G, x:Float, y:Float, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled)
			{
				...
				g.drawString("" + "Kill Flamez the Dragon", 25, 435);
				g.drawString("" + "Ultimate Boss Level", 385, 435);
				if((Engine.engine.getGameAttribute("Level Complete") && true))
				{
					g.drawString("" + "You've defeated the ultimate boss! ", 110, 210);
					g.drawString("" + "Collect the flaming egg and you win!", 100, 240);
				}
			}
		});
